...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "sat-connectivity",
            "sat-path-flow",
            "sat-path-flow-routes",
            "verify-sat-connectivity",
        ],
    )
...
def main():
    ...
    elif args.kind == "sat-path-flow-routes":
        tensor_tools.build_sat_path_flow_from_routes(config, time_slice_s=args.time_slice_s)
