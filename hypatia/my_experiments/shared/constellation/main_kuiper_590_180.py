"""Kuiper-like 590 km, 33 degree compact shell.

This scales the Kuiper 33 degree primary shell down to
...
BASE_NAME = "kuiper_590_180"
NICE_NAME = "Kuiper-590-180"
...
# 96.3 minute orbital period from the Kuiper 590 km / 33 degree shell.
MEAN_MOTION_REV_PER_DAY = 1440.0 / 96.3
ALTITUDE_M = 590000
...
def main():
    args = sys.argv[1:]
    if len(args) != 6:
        print("Usage: python main_kuiper_590_180.py [duration_s] [time_step_ms] "
