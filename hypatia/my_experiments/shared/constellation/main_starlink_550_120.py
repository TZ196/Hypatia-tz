"""Reduced Starlink 550 km shell for small matrix-filling experiments.

This keeps Starlink-like altitude/inclination while reducing the shell to
10 orbital planes x 12 satellites per plane = 120 satellites.
"""
...
BASE_NAME = "starlink_550_120"
NICE_NAME = "Starlink-550-120"
...
def main():
    args = sys.argv[1:]
    if len(args) != 6:
        print("Usage: python main_starlink_550_120.py [duration_s] [time_step_ms] "
