"""Reduced Starlink 550 km shell for 168-satellite matrix experiments.

This keeps Starlink-like altitude/inclination while using
...
BASE_NAME = "starlink_550_168"
NICE_NAME = "Starlink-550-168"
...
def main():
    args = sys.argv[1:]
    if len(args) != 6:
        print("Usage: python main_starlink_550_168.py [duration_s] [time_step_ms] "
