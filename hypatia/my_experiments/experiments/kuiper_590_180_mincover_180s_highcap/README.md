# kuiper_590_180_mincover_180s_highcap

Kuiper-like 590 km, 33 degree compact shell high-capacity experiment:
...
- stability-aware distance routing with `isl_weight_scale=0.001`
...
The base min-cover event size is `300_000_000` bytes before timezone scaling.
