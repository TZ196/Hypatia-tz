...
consistent distance units for ISL/GSL weights, and sets `isl_weight_scale=0.001`
...
- `sat_path_bytes_mb_tensor.npy`: satellite path traffic in MB, rounded to 2 decimals, shape `(66, 66, 180)`
- `sat_path_drop_mb_tensor.npy`: satellite path drops in MB, rounded to 2 decimals, shape `(66, 66, 180)`
- `sat_path_rtt_ms_tensor.npy`: satellite path RTT in ms, rounded to 2 decimals, shape `(66, 66, 180)`
